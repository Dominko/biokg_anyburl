...
public class DiffRank1 {
	...
	public static void main(String[] args) {
		...
		ResultSet rs1            = new ResultSet("original", "exp/maxgroup/analysis/anyburl-c3-3600-100-test", true, 100);
		ResultSet rs2            = new ResultSet("reordered", "exp/maxgroup/analysis/fb237-preds-local-o1-n09-woff", true, 100);
		
	
		TripleSet triples = new TripleSet("../AnyBURL/data/FB237/test.txt");
